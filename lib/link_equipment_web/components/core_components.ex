defmodule LinkEquipmentWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LinkEquipmentWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LinkEquipmentWeb.Gettext, "errors", msg, opts)
    # end
